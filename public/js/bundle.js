...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYWppLXRoLXMiLCJhIjoiY2w3dTAzcXFtMTRqNzN1bnd5bGVwMHMweiJ9.B2Lui-rGbem5pbcg4lL5QQ';
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              ...
              window.setTimeout(function () {
                var markup = "<div class=\"alert alert--success\">Logged in successfully</div>";
                document.querySelector('body').insertAdjacentHTML('afterbegin', markup);
                window.setTimeout(function () {
                  var el = document.querySelector('.alert');
          ...
          case 7:
            ...
            window.setTimeout(function () {
              var markup = "<div class=\"alert alert--error\">Incorrect email or password</div>";
              document.querySelector('body').insertAdjacentHTML('afterbegin', markup);
              window.setTimeout(function () {
                var el = document.querySelector('.alert');
                el.parentElement.removeChild(el);
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              window.setTimeout(function () {
                var markup = "<div class=\"alert alert--success\">signed up successfully</div>";
                document.querySelector('body').insertAdjacentHTML('afterbegin', markup);
                window.setTimeout(function () {
                  var el = document.querySelector('.alert');
                  el.parentElement.removeChild(el);
          ...
          case 7:
            ...
            window.setTimeout(function () {
              var markup = "<div class=\"alert alert--error\">".concat(_context3.t0.response.data.message, "</div>");
              document.querySelector('body').insertAdjacentHTML('afterbegin', markup);
              window.setTimeout(function () {
                var el = document.querySelector('.alert');
                el.parentElement.removeChild(el);
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              window.setTimeout(function () {
                var markup = "<div class=\"alert alert--success\">".concat(type.toUpperCase(), " Updated  successfully</div>");
                document.querySelector('body').insertAdjacentHTML('afterbegin', markup);
                window.setTimeout(function () {
                  var el = document.querySelector('.alert');
                  el.parentElement.removeChild(el);
          ...
          case 8:
            _context.prev = 8;
            _context.t0 = _context["catch"](0);
            console.log('hello', _context.t0.response);
            window.setTimeout(function () {
              var markup = "<div class=\"alert alert--error\">".concat(_context.t0.response.data.message, "</div>");
              document.querySelector('body').insertAdjacentHTML('afterbegin', markup);
              window.setTimeout(function () {
                var el = document.querySelector('.alert');
                el.parentElement.removeChild(el); // location.reload(true);
              }, 2000);
            }, 1000);
...
exports.sendResetPassword = exports.emailSendForgotPassword = void 0;
...
function () {
        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              //   console.log('hellllo');
              window.setTimeout(function () {
                var markup = "<div class=\"alert alert--success\">check your email and reset password</div>";
                document.querySelector('body').insertAdjacentHTML('afterbegin', markup);
                window.setTimeout(function () {
                  var el = document.querySelector('.alert');
                  el.parentElement.removeChild(el); // location.assign('/');
                  // location.reload(true);
                }, 2000);
              }, 1000);
            }
  ...
  return function emailSendForgotPassword(_x) {
    return _ref.apply(this, arguments);
  };
}();

exports.emailSendForgotPassword = emailSendForgotPassword;
...
function () {
        ...
        switch (_context2.prev = _context2.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              //   console.log('hellllo');
              window.setTimeout(function () {
                var markup = "<div class=\"alert alert--success\">password reset successfully</div>";
                document.querySelector('body').insertAdjacentHTML('afterbegin', markup);
                window.setTimeout(function () {
                  var el = document.querySelector('.alert');
                  el.parentElement.removeChild(el);
          ...
          case 8:
            ...
            window.setTimeout(function () {
              var markup = "<div class=\"alert alert--error\">".concat(_context2.t0.response.data.message, "</div>");
              document.querySelector('body').insertAdjacentHTML('afterbegin', markup);
              window.setTimeout(function () {
                var el = document.querySelector('.alert');
                el.parentElement.removeChild(el);
  ...
  return function sendResetPassword(_x2, _x3, _x4) {
    return _ref2.apply(this, arguments);
  };
}();
...
var stripe = Stripe('pk_test_51Ll5TdSAcnJkiozQhFSxZ0U9kZIOrZmZNXn9l7ysilmg4TmB5yahBuTYTvYzdM3Pk4n5qYcAX81kW91v5wtxN7IQ0034e5cl4q');
...
var submitMailForgotPassword = document.querySelector('.form--emailSubmit');
var passwordSubmit = document.querySelector('.form--passwordSubmit');
...
if (submitMailForgotPassword) {
  submitMailForgotPassword.addEventListener('submit', function (e) {
    e.preventDefault();
    var email = document.getElementById('email').value;
    console.log(email);
    (0, _forgotPassword.emailSendForgotPassword)(email);
  });
}

if (passwordSubmit) {
  // console.log('ggggg');
  passwordSubmit.addEventListener('submit', function (e) {
    e.preventDefault();
    var password = document.getElementById('password').value;
    var passwordConfirm = document.getElementById('passwordConfirm').value;
    var token = document.getElementById('token').value;
    console.log(password, passwordConfirm, token);
    (0, _forgotPassword.sendResetPassword)(password, passwordConfirm, token);
  });
}
...
},{"./mapbox":"mapbox.js","./login":"login.js","./updateSetting":"updateSetting.js","./forgotPassword":"forgotPassword.js","./stripe":"stripe.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
